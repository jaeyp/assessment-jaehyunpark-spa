    ...
    return (
        <div className="flex-1 mx-8">
            <div className="flex justify-center mb-4">
                <img className="mt-2" src={logo} width="40px" alt="" />
                <a href="/#" className="text-blue-700 no-underline hover:no-underline font-bold text-2xl lg:text-4xl px-4">{title}</a>
            </div>
        </div>
    )
}
...
const Copyright = () => {
    return (
        <div className='flex justify-center text-gray-800 pb-6'>
            {'Copyright ©'}
            <a href="https://shakepay.co" className="text-gray-500 mx-1">
                shakepay.co
            </a>
            {'2020'}
        </div>
